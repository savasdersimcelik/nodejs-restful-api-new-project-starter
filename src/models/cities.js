...
const cities_schema = new Schema({
...
cities_schema.pre('findOneAndUpdate', updateAt).pre('updateOne', updateAt).pre('save', updateAt)

const cities = model('cities', cities_schema);
